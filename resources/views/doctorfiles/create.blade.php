     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="doctors_code" class="form-control" placeholder="Doctors_code">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="middle_initial" class="form-control" placeholder="Middle_inital">
